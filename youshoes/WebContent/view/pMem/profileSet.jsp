...
<body>
	<button type="button" onclick="location.href='${pageContext.request.contextPath}/profileUpdate.do'" class="btn btn-lg btn-default text-white btn-block">프로필 수정</button>
