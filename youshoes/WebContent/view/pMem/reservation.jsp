...
<body>
	...
	<div id="modal-form">
		<form>
			...
			<fieldset>
				<legend>시간 선택</legend>
				<input type="radio" name="radio" id="radio" value="09:00">09:00-10:00<br>
				<br> <input type="radio" name="radio" id="radio" value="10:00">10:00-11:00<br>
				<br> <input type="radio" name="radio" id="radio" value="11:00">11:00-12:00 <br>
				<br> <input type="radio" name="radio" id="radio" value="13:00">14:00-15:00<br>
				<br> <input type="radio" name="radio" id="radio" value="13:00">14:00-15:00<br>
				<br> <input type="radio" name="radio" id="radio" value="14:00">15:00-16:00<br>
				<br> <input type="radio" name="radio" id="radio" value="15:00">16:00-17:00<br>
				<br> <input type="radio" name="radio" id="radio" value="16:00">17:00-18:00<br>
			</fieldset>
		</form>
	</div>
	<!-- // 달력의 모달 부분 -->
